...
namespace BrightIdeasSoftware {
    ...
    public class FilterMenuBuilder {
        ...
        /// </summary>
        static public Bitmap ClearFilteringImage = SniffBrowser.Properties.Resources.clear_filter;

        /// <summary>
        /// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
        /// </summary>
        static public Bitmap FilteringImage = SniffBrowser.Properties.Resources.filter;
