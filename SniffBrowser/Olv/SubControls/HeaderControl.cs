...
namespace BrightIdeasSoftware {
    ...
    public class HeaderControl : NativeWindow {
        ...
        protected Rectangle DrawFilterIndicator(Graphics g, Rectangle r) {
            ...
            Image indicator = SniffBrowser.Properties.Resources.filter_icons3;
            int x = r.Right - width;
        ...
        private int CalculateFilterIndicatorWidth(Rectangle r) {
            if (SniffBrowser.Properties.Resources.filter_icons3 == null || r.Width < 48)
                return 0;
            return SniffBrowser.Properties.Resources.filter_icons3.Width + 1;
        }
